...
public class WindmillTrajectories {
    ...
    static {
        WindmillState collectLift = createWindmillState(Units.inchesToMeters(22), Units.degreesToRadians(267.809));
        // Algae
